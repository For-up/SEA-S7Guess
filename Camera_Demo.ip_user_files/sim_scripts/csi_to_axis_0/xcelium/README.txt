...
#
# Generated by export_simulation on Thu Jun 25 14:30:55 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './csi_to_axis_0.sh' script.

./csi_to_axis_0.sh -reset_run
...
./csi_to_axis_0.sh -noclean_files

For more information on the script, please type './csi_to_axis_0.sh -help'.
