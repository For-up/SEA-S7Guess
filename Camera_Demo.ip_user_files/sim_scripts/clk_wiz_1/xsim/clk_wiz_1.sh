...
#
# Generated by Vivado on Thu Jul 30 16:00:17 +0800 2020
...
# Script info
echo -e "clk_wiz_1.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_1 xil_defaultlib.clk_wiz_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clk_wiz_1 -key {Behavioral:sim_1:Functional:clk_wiz_1} -tclbatch cmd.tcl -log simulate.log
}
