...
-- Date        : Thu Jul 30 16:01:20 2020
-- Host        : LAPTOP-EJ7V6R4H running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               D:/FPGA/Camera_Demo2/Camera_Demo/Camera_Demo.srcs/sources_1/ip/csi2_d_phy_rx_0/csi2_d_phy_rx_0_sim_netlist.vhdl
...
entity csi2_d_phy_rx_0_line_if is
  port (
  ...
  attribute ORIG_REF_NAME of csi2_d_phy_rx_0_line_if : entity is "line_if";
end csi2_d_phy_rx_0_line_if;

architecture STRUCTURE of csi2_d_phy_rx_0_line_if is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity csi2_d_phy_rx_0_line_if_0 is
  port (
    D : out STD_LOGIC_VECTOR ( 7 downto 0 );
    data_rxp : in STD_LOGIC_VECTOR ( 0 to 0 );
    data_rxn : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of csi2_d_phy_rx_0_line_if_0 : entity is "line_if";
end csi2_d_phy_rx_0_line_if_0;

architecture STRUCTURE of csi2_d_phy_rx_0_line_if_0 is
  signal data_s : STD_LOGIC;
  signal NLW_ISERDESE2_inst_O_UNCONNECTED : STD_LOGIC;
  signal NLW_ISERDESE2_inst_SHIFTOUT1_UNCONNECTED : STD_LOGIC;
  signal NLW_ISERDESE2_inst_SHIFTOUT2_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity csi2_d_phy_rx_0_phy_clock_system is
  port (
    dclk : out STD_LOGIC;
    pclk : out STD_LOGIC;
    CLK : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of csi2_d_phy_rx_0_phy_clock_system : entity is "phy_clock_system";
end csi2_d_phy_rx_0_phy_clock_system;

architecture STRUCTURE of csi2_d_phy_rx_0_phy_clock_system is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity csi2_d_phy_rx_0_csi2_d_phy_rx is
  port (
    in_delay_clk : in STD_LOGIC;
    clk_rxp : in STD_LOGIC;
    clk_rxn : in STD_LOGIC;
  ...
  attribute C_ADD_IDELAYCTRL of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is "TRUE";
  attribute C_CALIB_WAIT : integer;
  attribute C_CALIB_WAIT of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is 8191;
  attribute C_D0_SWAP : string;
  attribute C_D0_SWAP of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is "FALSE";
  attribute C_D1_SWAP : string;
  attribute C_D1_SWAP of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is "FALSE";
  attribute C_D2_SWAP : string;
  attribute C_D2_SWAP of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is "FALSE";
  attribute C_D3_SWAP : string;
  attribute C_D3_SWAP of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is "FALSE";
  attribute C_DIFF_TERM : string;
  attribute C_DIFF_TERM of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is "FALSE";
  attribute C_IODELAY_GROUP : string;
  attribute C_IODELAY_GROUP of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is "csi_dly_grp";
  attribute C_NUM_LANES : integer;
  attribute C_NUM_LANES of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is 2;
  attribute C_NUM_LP_LANES : integer;
  attribute C_NUM_LP_LANES of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is 1;
  attribute C_RATE_LIMIT : integer;
  attribute C_RATE_LIMIT of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is 50;
  attribute C_USE_DELAY : string;
  attribute C_USE_DELAY of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is "TRUE";
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is "csi2_d_phy_rx";
end csi2_d_phy_rx_0_csi2_d_phy_rx;

architecture STRUCTURE of csi2_d_phy_rx_0_csi2_d_phy_rx is
...
\bits_gen[0].line_if_inst\: entity work.csi2_d_phy_rx_0_line_if
     port map (
      CLKB => dclk,
...
\bits_gen[1].line_if_inst\: entity work.csi2_d_phy_rx_0_line_if_0
     port map (
      CLKB => dclk,
...
clock_system_inst: entity work.csi2_d_phy_rx_0_phy_clock_system
     port map (
      CLK => \^rxbyteclkhs\,
      clk_rxn => clk_rxn,
      clk_rxp => clk_rxp,
...
entity csi2_d_phy_rx_0 is
  ...
  attribute NotValidForBitStream of csi2_d_phy_rx_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of csi2_d_phy_rx_0 : entity is "csi2_d_phy_rx_0,csi2_d_phy_rx,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of csi2_d_phy_rx_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of csi2_d_phy_rx_0 : entity is "csi2_d_phy_rx,Vivado 2018.3";
end csi2_d_phy_rx_0;

architecture STRUCTURE of csi2_d_phy_rx_0 is
  attribute C_ADD_IDELAYCTRL : string;
...
begin
U0: entity work.csi2_d_phy_rx_0_csi2_d_phy_rx
     port map (
      cl_enable => cl_enable,
