...
--               D:/FPGA/Camera_Demo2/Camera_Demo/Camera_Demo.srcs/sources_1/ip/rgb2dvi_0/rgb2dvi_0_sim_netlist.vhdl
-- Design      : rgb2dvi_0
...
entity rgb2dvi_0_OutputSERDES is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_0_OutputSERDES_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_0_OutputSERDES_0 : entity is "OutputSERDES";
end rgb2dvi_0_OutputSERDES_0;

architecture STRUCTURE of rgb2dvi_0_OutputSERDES_0 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal NLW_SerializerMaster_OFB_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_0_OutputSERDES_2 is
  port (
    TMDS_Data_p : out STD_LOGIC_VECTOR ( 0 to 0 );
    TMDS_Data_n : out STD_LOGIC_VECTOR ( 0 to 0 );
    SerialClk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_0_OutputSERDES_2 : entity is "OutputSERDES";
end rgb2dvi_0_OutputSERDES_2;

architecture STRUCTURE of rgb2dvi_0_OutputSERDES_2 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal NLW_SerializerMaster_OFB_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_0_OutputSERDES_4 is
  port (
    TMDS_Data_p : out STD_LOGIC_VECTOR ( 0 to 0 );
    TMDS_Data_n : out STD_LOGIC_VECTOR ( 0 to 0 );
    SerialClk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_0_OutputSERDES_4 : entity is "OutputSERDES";
end rgb2dvi_0_OutputSERDES_4;

architecture STRUCTURE of rgb2dvi_0_OutputSERDES_4 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal NLW_SerializerMaster_OFB_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_0_SyncAsync_6 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_0_SyncAsync_6 : entity is "SyncAsync";
end rgb2dvi_0_SyncAsync_6;

architecture STRUCTURE of rgb2dvi_0_SyncAsync_6 is
  signal oSyncStages : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute async_reg : string;
  attribute async_reg of oSyncStages : signal is "true";
  attribute ASYNC_REG_boolean : boolean;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \rgb2dvi_0_SyncAsync__parameterized1\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \rgb2dvi_0_SyncAsync__parameterized1\ : entity is "SyncAsync";
end \rgb2dvi_0_SyncAsync__parameterized1\;

architecture STRUCTURE of \rgb2dvi_0_SyncAsync__parameterized1\ is
  signal oSyncStages : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute async_reg : string;
  attribute async_reg of oSyncStages : signal is "true";
  attribute ASYNC_REG_boolean : boolean;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_0_TMDS_Encoder is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_0_TMDS_Encoder_1 is
  port (
    Q : out STD_LOGIC_VECTOR ( 9 downto 0 );
    PixelClk : in STD_LOGIC;
    vid_pData : in STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_0_TMDS_Encoder_1 : entity is "TMDS_Encoder";
end rgb2dvi_0_TMDS_Encoder_1;

architecture STRUCTURE of rgb2dvi_0_TMDS_Encoder_1 is
  signal cnt_t_2 : STD_LOGIC_VECTOR ( 4 downto 1 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_0_TMDS_Encoder_3 is
  port (
    Q : out STD_LOGIC_VECTOR ( 9 downto 0 );
    PixelClk : in STD_LOGIC;
    vid_pData : in STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_0_TMDS_Encoder_3 : entity is "TMDS_Encoder";
end rgb2dvi_0_TMDS_Encoder_3;

architecture STRUCTURE of rgb2dvi_0_TMDS_Encoder_3 is
  signal cnt_t_2 : STD_LOGIC_VECTOR ( 4 downto 1 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_0_ResetBridge_5 is
  port (
    AS : out STD_LOGIC_VECTOR ( 0 to 0 );
    aRst_n : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_0_ResetBridge_5 : entity is "ResetBridge";
end rgb2dvi_0_ResetBridge_5;

architecture STRUCTURE of rgb2dvi_0_ResetBridge_5 is
  signal aRst_int_0 : STD_LOGIC;
  attribute RTL_KEEP : string;
  attribute RTL_KEEP of aRst_int_0 : signal is "true";
begin
SyncAsyncx: entity work.rgb2dvi_0_SyncAsync_6
     port map (
      AS(0) => AS(0),
      \oSyncStages_reg[0]_0\(0) => aRst_int_0,
...
entity rgb2dvi_0_ClockGen is
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_0_ClockGen : entity is "ClockGen";
end rgb2dvi_0_ClockGen;

architecture STRUCTURE of rgb2dvi_0_ClockGen is
...
LockLostReset: entity work.rgb2dvi_0_ResetBridge_5
     port map (
      AS(0) => pRst,
      aRst_n => aRst_n,
      \oSyncStages_reg[1]\ => \oSyncStages_reg[1]\
    );
PLL_LockSyncAsync: entity work.\rgb2dvi_0_SyncAsync__parameterized1\
     port map (
      D(0) => oOut,
...
entity rgb2dvi_0_rgb2dvi is
  ...
  attribute kClkRange of rgb2dvi_0_rgb2dvi : entity is 1;
  attribute kGenerateSerialClk : string;
  attribute kGenerateSerialClk of rgb2dvi_0_rgb2dvi : entity is "TRUE";
...
architecture STRUCTURE of rgb2dvi_0_rgb2dvi is
  ...
  signal p_1_in : STD_LOGIC;
begin
\ClockGenInternal.ClockGenX\: entity work.rgb2dvi_0_ClockGen
     port map (
      PixelClk => PixelClkIO,
...
ClockSerializer: entity work.rgb2dvi_0_OutputSERDES
     port map (
      PixelClk => PixelClkIO,
      SerialClk => SerialClkIO,
...
\DataEncoders[0].DataEncoder\: entity work.rgb2dvi_0_TMDS_Encoder
     port map (
      PixelClk => PixelClk,
...
\DataEncoders[0].DataSerializer\: entity work.rgb2dvi_0_OutputSERDES_0
     port map (
      PixelClk => PixelClkIO,
      SerialClk => SerialClkIO,
...
\DataEncoders[1].DataEncoder\: entity work.rgb2dvi_0_TMDS_Encoder_1
     port map (
      PixelClk => PixelClk,
...
\DataEncoders[1].DataSerializer\: entity work.rgb2dvi_0_OutputSERDES_2
     port map (
      PixelClk => PixelClkIO,
      SerialClk => SerialClkIO,
...
\DataEncoders[2].DataEncoder\: entity work.rgb2dvi_0_TMDS_Encoder_3
     port map (
      PixelClk => PixelClk,
...
\DataEncoders[2].DataSerializer\: entity work.rgb2dvi_0_OutputSERDES_4
     port map (
      PixelClk => PixelClkIO,
      SerialClk => SerialClkIO,
...
entity rgb2dvi_0 is
  ...
  attribute x_core_info of rgb2dvi_0 : entity is "rgb2dvi,Vivado 2018.3";
end rgb2dvi_0;

architecture STRUCTURE of rgb2dvi_0 is
  attribute kClkPrimitive : string;
...
begin
U0: entity work.rgb2dvi_0_rgb2dvi
     port map (
      PixelClk => PixelClk,
      SerialClk => '0',
      TMDS_Clk_n => TMDS_Clk_n,
